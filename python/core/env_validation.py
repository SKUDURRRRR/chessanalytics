...
class DatabaseConfig(BaseModel):
    ...
    url: HttpUrl = Field(..., description="Supabase database URL", alias='SUPABASE_URL')
    anon_key: str = Field(..., min_length=1, description="Supabase anonymous key", alias='SUPABASE_ANON_KEY')
