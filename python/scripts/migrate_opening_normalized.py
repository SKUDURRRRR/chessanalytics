...
def migrate_games(dry_run: bool = True, batch_size: int = 500):
    ...
    try:
        ...
        print(f"✓ Found {total_games} total games in database")
        print()
    except Exception as e:
        print(f"✗ Failed to count games: {e}")
        return
                ...
                try:
                    ...
                    for update in batch_updates:
                        try:
                            ...
                            print(f"    ⚠ Failed to update game {update['id']}: {str(e)}")
                    print(f"  ✓ Updated {updated_count}/{len(batch_updates)} games")
                except Exception as e:
