...
SELECT
    ...
    ma.good_moves,
    ma.acceptable_moves,
    NULL AS opponent_average_centipawn_loss,
    NULL AS opponent_worst_blunder_centipawn_loss,
    NULL AS opponent_time_management_score,
    NULL AS average_evaluation,
    NULL AS processing_time_ms,
    NULL AS stockfish_depth,
...
WHERE ga2.game_id IS NULL;  -- Only include if not in game_analyses
