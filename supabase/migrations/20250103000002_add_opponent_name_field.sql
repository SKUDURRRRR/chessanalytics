-- Add opponent_name field to games table
-- This migration adds the opponent_name field to store opponent usernames

-- Add the opponent_name column to the games table
