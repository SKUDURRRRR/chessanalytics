  ...
  return (
    <div className="bg-blue-900 text-white rounded-lg shadow-md p-6">
      ...
      <p className="text-blue-100 mb-4">
        You have {score >= 70 ? 'strong' : score >= 60 ? 'decent' : 'developing'} opening knowledge
        and understand {score >= 70 ? 'advanced' : 'basic'} theoretical concepts.
      </p>
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <p className="text-sm text-blue-100">
            ...
            {score >= 70
              ? 'gives you strong positions'
              : score >= 60
                ? 'helps you get reasonable positions'
                : 'needs improvement to avoid early disadvantages'}{' '}
            in most games.
          </p>
        </div>
