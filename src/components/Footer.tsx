      ...
      <div className="max-w-5xl mx-auto px-6 py-5">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <a
            ...
            className="flex items-center gap-2 px-3.5 py-1.5 rounded-md text-body font-medium text-gray-500 hover:text-gray-400 hover:bg-white/[0.03] transition-colors"
