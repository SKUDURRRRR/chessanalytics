...
export default function UsageLimitModal({
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div
        className="relative w-full max-w-2xl bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-700/30 overflow-hidden transform transition-all"
      ...
      >
        ...
        <div className="relative px-8 pt-8 pb-6 border-b border-slate-700/30">
          ...
          <div className="text-center">
            {/* Analysis icon */}
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500/20 via-pink-500/20 to-blue-500/20 border border-purple-500/20 mb-4">
        ...
        <div className="px-8 py-8">
          {isAuthenticated ? (
            <>
              {/* Comparison Section */}
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 mb-6 border border-slate-700/30">
                <div className="flex items-center justify-between mb-4 pb-4 border-b border-slate-700/30">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-rose-400 font-bold text-base">{analyzedGames} games</span>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-emerald-400 font-bold text-base">ALL games!</span>
