...
export default function UsageLimitModal({
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div
        className="relative w-full max-w-lg bg-surface-1 rounded-lg shadow-card overflow-hidden transform transition-colors max-h-[90vh] overflow-y-auto"
      ...
      >
        ...
        <div className="relative px-6 pt-6 pb-4 border-b border-white/[0.04]">
          <div className="absolute top-4 right-4">
            <button
              onClick={onClose}
              className="text-gray-500 hover:text-white transition-colors p-1.5 rounded-lg hover:bg-surface-3/30"
              aria-label="Close"
            >
          ...
          <div className="text-center">
            {/* Analysis icon */}
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-lg bg-surface-2 shadow-card mb-3">
          ...
          {isAuthenticated ? (
            <>
              ...
              <div className="bg-surface-2/50 rounded-lg p-5 mb-4 shadow-card">
                <div className="flex items-center justify-between mb-3 pb-3 border-b border-white/[0.04]">
                  <span className="text-gray-400 text-sm font-medium">Current Analysis:</span>
                  <div className="flex items-center gap-2">
                    <span className="text-rose-400 font-semibold text-sm">{analyzedGames} games</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-400 text-sm font-medium">With Pro:</span>
                  <div className="flex items-center gap-2">
                    <span className="text-emerald-400 font-semibold text-sm">ALL games!</span>
              ...
              <div className="mb-5">
                <div className="flex items-center gap-2.5 mb-4">
                  <div className="w-7 h-7 rounded-lg bg-surface-2 shadow-card flex items-center justify-center">
                ...
                <div className="space-y-2.5">
                  {[
                    ...
                    <div key={index} className="flex items-start gap-2.5">
                      <div className="flex-shrink-0 w-4 h-4 rounded-full bg-emerald-500/20 shadow-card flex items-center justify-center mt-0.5">
              ...
              <div className="space-y-3">
                <a
                  href="/pricing"
                  className="flex items-center justify-center gap-2 w-full px-6 py-3.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg font-semibold text-center transition-colors"
                >
            ...
            <>
              ...
              <div className="mb-5">
                ...
                <div className="bg-surface-2/40 rounded-lg p-5 mb-4 shadow-card">
                  <div className="flex items-center gap-2.5 mb-4">
                    <div className="w-7 h-7 rounded-lg bg-surface-2 shadow-card flex items-center justify-center flex-shrink-0">
