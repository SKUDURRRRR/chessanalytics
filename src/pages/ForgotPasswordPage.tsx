    ...
    <div className="min-h-screen bg-surface-base flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-8 space-y-6">
          {error && (
            <div className="bg-red-900/50 shadow-card text-red-200 px-4 py-3 rounded">
              {error}
            </div>
          )}
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                className="mt-1 appearance-none block w-full px-3 py-2 shadow-card rounded-md bg-surface-1 text-white placeholder-gray-600 focus:outline-none focus:ring-blue-500 sm:text-sm"
