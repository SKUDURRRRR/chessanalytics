  ...
  return (
    <div className="max-w-5xl mx-auto px-8 py-10">
      <div className="bg-surface-1 rounded-lg shadow-card p-6">
        <h1 className="text-title font-semibold text-white mb-2">Privacy Policy</h1>
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-gray-400">
          <section>
            <h2 className="text-section font-semibold text-white mt-8 mb-4">1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 className="text-section font-semibold text-white mt-8 mb-4">2. Information We Collect</h2>

            <h3 className="text-body font-semibold text-white mt-6 mb-3">2.1 Information You Provide</h3>
            ...
            <h3 className="text-body font-semibold text-white mt-6 mb-3">2.2 Information Automatically Collected</h3>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h3 className="text-body font-semibold text-white mt-6 mb-3">2.3 Information from Third Parties</h3>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-section font-semibold text-white mt-8 mb-4">3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-section font-semibold text-white mt-8 mb-4">4. Data Storage and Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-section font-semibold text-white mt-8 mb-4">5. Information Sharing and Disclosure</h2>

            <h3 className="text-body font-semibold text-white mt-6 mb-3">5.1 Service Providers</h3>
            ...
            <h3 className="text-body font-semibold text-white mt-6 mb-3">5.2 Legal Requirements</h3>
            ...
            <h3 className="text-body font-semibold text-white mt-6 mb-3">5.3 Business Transfers</h3>
            <p>
          ...
          <section>
            <h2 className="text-section font-semibold text-white mt-8 mb-4">6. Your Rights and Choices</h2>

            <h3 className="text-body font-semibold text-white mt-6 mb-3">6.1 Access and Portability</h3>
            <p>
              You may access your account and game data through your dashboard. To request a data export, contact <a href="mailto:support@chessdata.app" className="text-cta hover:text-cta-hover underline">support@chessdata.app</a>.
            </p>

            <h3 className="text-body font-semibold text-white mt-6 mb-3">6.2 Correction</h3>
            <p>
              You can update account details (email, display name) via your account settings. For other changes, contact us.
            </p>

            <h3 className="text-body font-semibold text-white mt-6 mb-3">6.3 Deletion</h3>
            <p>
              You may request full account deletion by contacting <a href="mailto:support@chessdata.app" className="text-cta hover:text-cta-hover underline">support@chessdata.app</a>.
            </p>
            <p className="mt-2">
              We will permanently delete your data within 30 days, except where retention is required by law.
            </p>

            <h3 className="text-body font-semibold text-white mt-6 mb-3">6.4 Opt-Out</h3>
            <p>
            ...
            <h3 className="text-body font-semibold text-white mt-6 mb-3">6.5 Data Retention</h3>
            <p>
          ...
          <section>
            <h2 className="text-section font-semibold text-white mt-8 mb-4">7. Cookies and Tracking Technologies</h2>
            <p>
          ...
          <section>
            <h2 className="text-section font-semibold text-white mt-8 mb-4">8. Third-Party Services</h2>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Lichess:</strong> <a href="https://lichess.org/privacy" target="_blank" rel="noopener noreferrer" className="text-cta hover:text-cta-hover underline">Privacy Policy</a></li>
              <li><strong>Chess.com:</strong> <a href="https://www.chess.com/legal/privacy" target="_blank" rel="noopener noreferrer" className="text-cta hover:text-cta-hover underline">Privacy Policy</a></li>
              <li><strong>Stripe:</strong> <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="text-cta hover:text-cta-hover underline">Privacy Policy</a></li>
              <li><strong>Supabase:</strong> <a href="https://supabase.com/privacy" target="_blank" rel="noopener noreferrer" className="text-cta hover:text-cta-hover underline">Privacy Policy</a></li>
            </ul>
          </section>

          <section>
            <h2 className="text-section font-semibold text-white mt-8 mb-4">9. Children's Privacy</h2>
            <p>
              Our Service is not intended for children under 13.
            </p>
            <p className="mt-4">
              We do not knowingly collect personal data from children. If you believe a child has provided us information, contact us immediately at <a href="mailto:support@chessdata.app" className="text-cta hover:text-cta-hover underline">support@chessdata.app</a> and we will delete it.
            </p>
          </section>

          <section>
            <h2 className="text-section font-semibold text-white mt-8 mb-4">10. International Users</h2>
            <p>
            ...
            <p className="mt-4">
              Contact <a href="mailto:support@chessdata.app" className="text-cta hover:text-cta-hover underline">support@chessdata.app</a> to exercise these rights.
            </p>
          </section>

          <section>
            <h2 className="text-section font-semibold text-white mt-8 mb-4">11. Data Breach Notification</h2>
            <p>
          ...
          <section>
            <h2 className="text-section font-semibold text-white mt-8 mb-4">12. Changes to This Privacy Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-section font-semibold text-white mt-8 mb-4">13. Contact Us</h2>
            <p>
              If you have any questions, concerns, or requests regarding this Privacy Policy, contact us at:
            </p>
            <p className="mt-4">
              📧 Email: <a href="mailto:support@chessdata.app" className="text-cta hover:text-cta-hover underline">support@chessdata.app</a>
            </p>
            <p className="mt-4">
          ...
          <section>
            <h2 className="text-section font-semibold text-white mt-8 mb-4">14. California Privacy Rights (CCPA)</h2>
            <p>
            ...
            <p className="mt-4">
              To exercise these rights, contact <a href="mailto:support@chessdata.app" className="text-cta hover:text-cta-hover underline">support@chessdata.app</a>.
            </p>
          </section>
        </div>
