        ...
        <div className="bg-surface-1 shadow-card rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-end">
              <Link to="/forgot-password" className="text-small font-medium text-gray-500 hover:text-gray-400 transition-colors">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center">
                <span className="px-2 bg-surface-1 text-caption text-gray-500">Or continue with</span>
              </div>
            </div>
            ...
            <div className="mt-6 flex justify-center">
              <button
                ...
                disabled={loading}
                className="w-full max-w-xs rounded-md bg-surface-2 shadow-input px-5 py-2.5 text-body font-medium text-gray-300 hover:shadow-card-hover hover:text-gray-200 transition-colors disabled:cursor-not-allowed disabled:opacity-50 inline-flex justify-center items-center"
              >
